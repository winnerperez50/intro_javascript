...
let miembrosFamilia = ["Wilfido", "Roxanna", "Winner", "Wilmer"];
...
let datosPersonales = {
  ...
  paisesVisitar: ["canada", "japon", "Europa", "UUEE", "alemania"],
...
console.log(
  `El primer pais que me gustaia visitar ${datosPersonales.paisesVisitar[1]}`
);
